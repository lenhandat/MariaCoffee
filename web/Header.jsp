...
<html>
    ...
    <body>
        ...
        <div class="menu">
            <ul class="nav">
                <li><a class="${activeMenu}" href="Home">Home</a></li>
                <li><a class="${activeList}" href="List">About my Cakes</a></li>
                <li><a class="${activeInfor}" href="Location">Find Maria's Cafe</a></li>
            </ul>
        </div>
    </body>
</html>
